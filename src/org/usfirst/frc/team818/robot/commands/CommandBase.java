...
public abstract class CommandBase extends Command {
	...
	public static void init() {
		...
		elevator = new ElevatorSubsystem(Constants.elevatorMotorPort1, Constants.elevatorMotorPort2, Constants.limitSwitchPortTop, Constants.limitSwitchPortBottom, Constants.limitSwitchPortElevator, Constants.limitSwitchPortCarrage, Constants.elevatorEnabled);
