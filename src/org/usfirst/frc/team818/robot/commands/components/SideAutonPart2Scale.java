 ...
 */
public class SideAutonPart2Scale extends CommandGroup {
	...
	public SideAutonPart2Scale(String side, String targetPosition) {
		...
		if(side.equals("left")){
			if(gameData.charAt(0) == 'L')
				...
				target = 2;
			if(targetPosition.equals("Scale"))
				target = 3;
			sideM = -1;
		}else{
		...
		addSequential(new Drive4Distance(-42 + Constants.robotHalfLength));
